#!/usr/bin/env python3
"""
Script pour mettre à jour la fonction generatePresentationPatientSection avec les améliorations
"""
        ...
        presentation.sections.forEach((section, index) => {
            ...
            if (section.subsections && section.subsections.length > 0) {
                section.subsections.forEach(subsection => {
                    ...
                    // Questions avec réponses améliorées
...
# Compter les accolades pour trouver la fin exacte de la fonction
...
if match:
    ...
    print(f"✓ Fonction generatePresentationPatientSection mise à jour")
